<script>
 ...
 const url  = "https://corsany-1-g0403094.deta.app/https://poophd.com/api/list?key=raQu2lrd&folder=KKOHzujpgro"
...
<div style="margin:10px">
  ...
  <h5 style="font-weight:bold">Request BOKEP Kalian</h5>
</div>
<div class="row">
